...
public class NadadorTest {
    ...
    @Before
    public void setUp() {
        // Este nadador con sus cuatro resultados está disponible para
        // cada prueba
        thisYear = LocalDate.now().getYear();
        n1 = new Nadador(" José  -  Alfredo \"El Torrijas\"  ",
                " Nuñez de   Garcia-Flojera",
                LocalDate.of(thisYear - 14, 1, 1) // 14 años
        );
    ...
    public void testConstructors() {
        // Comprobar que los constructore lanzan las excepciones
    ...
    public void testRestriccionesAccesores() {
        // Comprueba que los accesores lanzan excepciones
        boolean hayExcepcion;
    ...
    public void testAccesors() {
        // comprueba que los datos obtenidos del nadador son los que
        // entraron y se manipularon correctamente
    ...
    public void testCategoriaEdad() {
        // Comprueba que se categoriza correctamente a los nadadores por edad
    ...
    public void testResultados() {
        // Comprueba el mejor y peor resultado
    ...
    public void testFilterPorEstilo() {
        // Comprueba el método filterPorEstilo
    ...
    public void testGetVelocidades() {
        // Comprobar el cálculo de velocidades
    ...
    public void testDeletePorMetros() {
        // Comprobar borrado por distancia
